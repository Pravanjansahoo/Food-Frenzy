...
const Order = () => {
  ...
  if (loading)
    return (
      <div className={layoutClasses.page + "flex justify-center items-center"}>
                    ...
                    <tr key={order._id} className={tableClasses.row}>
                      ...
                      <td className={tableClasses.cellBase}>
                        <div className=" text-amber-100/80 text-sm max-w-[200px]">
                          {order.address},{order.address} - {order.zipCode}
                        </div>
                      </td>
                                ...
                                <>
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 text-amber-400/60">
                                      <span>
                                        &#x20B9;
                                        {Number(itm.item?.price ?? 0).toFixed(2)}
                                      </span>
                                      <span>&middot;</span>
