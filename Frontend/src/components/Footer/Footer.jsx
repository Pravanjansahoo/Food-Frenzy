        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-amber-200/90 text-sm font-sacramento italic">
              ...
              Savor handcarfted perfection, delivered with love. <br />
            </p>
            <form onSubmit={handleSubmit} className="relative mt-4 group">
              ...
              <div className="relative ">
                ...
                <button
                  type="submit"
                  className="absolute right-1 top-1 bg-linear-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all duration-500"
                >
                  ...
                  <span className="absolute inset-0 -trnslate-x-full bg-linear-to-br from-transparent via-amber-50/30 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
                </button>
              </div>
            </form>
          </div>
              ...
              <div className="flex space-x-4">
                {socialIcons.map(({ icon: Icon, link, color, label }, idx) => (
                  <a
                    ...
                    href={link}
                    key={idx}
                    className="text-2xl bg-amber-400/20 p-3 rounded-full hover:bg-amber-400/20 hover:scale-110 transition-all duration-300 relative group"
                    style={{ color }}
                  >
