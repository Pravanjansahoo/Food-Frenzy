...
const MyOrder = () => {
  ...
  if (error)
    return (
      <div className=" min-h-screen bg-linear-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] flex items-center justify-center text-red-400 text-xl gap-4">
  ...
  return (
    <div className="min-h-screen bg-linear-to-r from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="bg-[#4b3b3b]/80 backdrop-blur-sm rounded-3xl p-8  shadow-2xl border-2 border-amber-500/20">
          <h2 className=" text-3xl font-bold mb-8 bg-linear-to-r from-amber-300 to-amber-500 bg-clip-text text-transparent text-center">
            Order History
          </h2>
              ...
              <tbody>
                {orders.map((order) => {
                  ...
                  return (
                    <tr
                      key={order._id}
                      className=" border-b border-amber-500/30 transition-colors group"
                    >
                      ...
                      <td className="p-4">
                        <div className="space-y-2">
                          {order.items.map((item, index) => (
                            <div
                              key={`${order._id}-${index}`}
                              className="flex items-center gap-3 p-2 bg-[#3a2a2b]/50 rounded-lg"
                            >
                              {item.item?.imageUrl && (
                                <img
                                  src={
                              ...
                              <div className="flex-1">
                                <span className="text-amber-100 text-sm block">
                                  {item.item?.name || "Item"}
                                </span>
