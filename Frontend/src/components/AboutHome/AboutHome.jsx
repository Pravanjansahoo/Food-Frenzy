    ...
    <div className="min-h-screen bg-linear-to-br from-[#0f0a0a] via--[#1a1212] to-[#2a1e1e] text-white py-10 sm:py-20 relative overflow-hidden ">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative">
        <div className="w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
          <div className="space-y-4 sm:space-y-8 px-8 sm:px-0">
            <h2 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">
              ...
              <span className="inline-block mt-2 sm:mt-4 text-2xl sm:text-3xl md:text-4xl opacity-90 font-light ">
                Where Flavours Dance &amp; Moments Sizzle
              </span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl opacity-90 max-w-3xl leading-relaxed max-w-3xl font-serif italic border-l-4 bg-amber-500/60 pl-4 sm:py-6 py-2 bglinear-to-r from-white/5 to-transparent">
              "In our kitchen, passion meets precision . We craft not just
              meals, but unforgettable experiences. Each dish is a symphony of
              flavors, a celebration of culinary artistry. Join us on a journey
              where every bite tells a story, and every meal is a masterpiece."
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0">
            <Link
              to="/about"
              className="px-4 sm:px-6 py-6 sm:py-3 bg-linear-to-r from-amber-500 to-orange-600 rounded-xl font-bold hover:scale-[1.02] transition-transform duration-300 flex items-center gap-2 sm:gap-3 shadow-xl hover:shadow-amber-500/20 group relative overflow-hidden"
            >
        ...
        <div className="w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative group transform hover:scale-[1.01] transition-all duration-500">
          <div className="relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-600/40 transition duration-500 shadow-2xl shadow-black/50">
            <div className="absolute inset-0 bg-linear-to-br from-amber-400/15 via-transparent to-amber-600/10 mix-blend-light"/>
              <img
                src={AboutImage}
                alt="Restaurant"
              ...
              <div className='abaolute -top-6 -right-6 w-24 h-24 bg-amber-500/10 rounded-full blur-xl'/>
        </div>
      </div>
      <FloatingParticle />
    </div>
