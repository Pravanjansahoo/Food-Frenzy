...
const Banner = () => {
  ...
  const handleSearch = (e) => {
    ...
    // handle search submission here (e.g., read form values or navigate)
  };
  const { bannerImage, orbitImages, video } = bannerAssets;

  return (
    <div className="relative">
      <div className="bg-gradient-to-r from-amber-900 via-amber-800 to-amber-700  text-white py-16 px-4 sm:px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-amber-900/20  to-amber-700 opacity-50" />

        <div className=" max-w-6xl mx-auto flex flex-col md:flew-row items-center gap-12 relative z-10">
          {/* {LEFT CONTENT} */}
          <div className="flex-1 space-y-8 relative md:pr-8  lg:pr-20  text-center md:text-left">
            <div className="flex justify-between">
              <div>
                ...
                <form
                  ...
                  className="relative mt-5 mx-w-2xl mx-auto md:mx-0 group"
                >
                  <div className="relative flex items-center bg-amber-900/30 rounded-xl border-2 border-amber-500/30 shadow-2xl hover:bg-amber-400/50 transition-all duration-300">
                    ...
                    <input
                      ...
                      placeholder="Discover your favoite meal....."
              ...
              {/* {RIGHT IMAGE  CONTAINER WITH ORBITAL IMAGE } */}
              <div className="flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]">
                {/* {MAIN IMAGE} */}

                <div className="relative rounded-full  p-1 bg-linear-to-br from-amber-700 via-amber-800 to-amber-400 shadow-2xl z-20 w-[250px] xs:w-[300px] sm:w-[350px] h-[250px] xs:h-[300px] sm:h-[350px] mx-auto">
                  <img
                    src={bannerImage}
                    alt="Banner"
                    className="rounded-full border-4 xs:border-8 border-amber-900/50 w-full h-full object-cover object-top"
                  />
                  <div className="absolute inset-0 rounded-full bg-linear-to-b from-transparent to-amber-900/40 mix-blend-multiply" />
                </div>
                {/* {ORBITAL IMAGE} */}
                {orbitImages.map((ImgSrc, index) => (
                  <div
                    ...
                    } xs:w-[100px] h-[80px] xs:h-[100px] sm:h-[150px]
                     `}
                  >
                    <img
                      src={ImgSrc}
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-6 ">
              ...
              <button
                ...
                className="group flex items-center gap-3 bg-linear-to-r from-amber-400 to-amber-300 hover:from-amber-300 hover:to-amber-200 px-6 py-3 rounded-xl transition-all duration-300 shadow-lg hover:shadow-amber-300/30"
              >
